    ...
    computed: {
        renderComponents() {
            ...
            if (settings) {
                ...
                if (findLayout == "demo") return () => import("~/components/site/Demo/pages/NewsDetail.vue")
                if (findLayout == "alkademi") return () => import("~/components/site/Alkademi/pages/News/_id/_title.vue")
                if (findLayout == "jongkreatif") return () => import("~/components/site/JongKreatif/pages/NewsDetail.vue")
