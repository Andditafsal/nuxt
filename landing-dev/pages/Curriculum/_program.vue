        ...
        renderComponents() {
            ...
            if (settings) {
                ...
                if (findLayout) {
                    ...
                    if (findLayout == "demo") return () => import("~/components/site/Demo/pages/CurriculumDetail.vue")
                    if (findLayout == "alkademi") return () => import("~/components/site/Alkademi/pages/Curriculum/program.vue")
                    if (findLayout == "jongkreatif") return () => import("~/components/site/JongKreatif/pages/CurriculumDetail.vue")
