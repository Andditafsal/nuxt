        ...
        renderComponents() {
            ...
            if (settings) {
                ...
                if (findLayout) {
                    ...
                    if (findLayout == "demo") return () => import("~/components/site/Demo/pages/Curriculum.vue")
                    if (findLayout == "alkademi") return () => import("~/components/site/Alkademi/pages/Curriculum/index.vue")
                    if (findLayout == "jongkreatif") return () => import("~/components/site/JongKreatif/pages/Curriculum.vue")
