    ...
    computed: {
        renderComponents() {
            ...
            if (settings) {
                ...
                if (findLayout == "smkcoding") return () => import("~/components/site/SMKCoding/pages/Mentor.vue")
                if (findLayout == "demo") return () => import("~/components/site/Demo/pages/Mentor.vue")
                if (findLayout == "jongkreatif") return () => import("~/components/site/JongKreatif/pages/Mentor.vue")
