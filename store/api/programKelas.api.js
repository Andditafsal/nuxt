...
const apiGetProgramsKelas = () => {
    ...
    return httpClient.get(BASE_URL + 'programsKelas')
}
...
const apiGetProgramAws = () => {
    ...
    return httpClientAws.get(BASE_URL + 'programsKelas')
}

export { apiGetProgramsKelas, apiGetProgramAws }